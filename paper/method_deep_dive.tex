...
\begin{example}[Rare Regime Resilience --- Empirical Validation with All MARL Methods]
We tested rare regime performance across 6 domains (30 trials each), comparing NichePopulation against Homogeneous and \textbf{all four MARL methods}: IQL, VDN, QMIX, and MAPPO.

\textbf{Raw Performance in Rare Regimes:}
\begin{center}
\begin{tabular}{lccccccc}
\toprule
Domain & Rare Regime & Niche & Homo & IQL & VDN & QMIX & MAPPO \\
\midrule
Weather & Extreme (10\%) & \textbf{0.982} & 0.541 & 0.670 & 0.656 & 0.664 & 0.654 \\
Commodities & Volatile (15\%) & \textbf{0.818} & 0.641 & 0.698 & 0.681 & 0.676 & 0.670 \\
Traffic & Morning (9\%) & \textbf{1.074} & 0.941 & 0.925 & 0.925 & 0.934 & 0.931 \\
Crypto & Volatile (15\%) & \textbf{0.823} & 0.741 & 0.732 & 0.733 & 0.736 & 0.737 \\
\bottomrule
\end{tabular}
\end{center}

\textbf{NichePopulation Improvement vs Each Baseline:}
\begin{center}
\begin{tabular}{lccccc}
\toprule
Domain & vs Homo & vs IQL & vs VDN & vs QMIX & vs MAPPO \\
\midrule
Weather & \textbf{+81.5\%} & +46.7\% & +49.7\% & +48.0\% & +50.2\% \\
Commodities & \textbf{+27.6\%} & +17.3\% & +20.1\% & +21.0\% & +22.1\% \\
Traffic & +14.1\% & \textbf{+16.1\%} & +16.1\% & +14.9\% & +15.3\% \\
Crypto & +11.1\% & \textbf{+12.4\%} & +12.3\% & +11.9\% & +11.8\% \\
\midrule
\textbf{Average} & \textbf{+21.5\%} & +15.6\% & +16.1\% & +15.6\% & +16.0\% \\
\bottomrule
\end{tabular}
\end{center}
...
\textbf{Key findings}:
\begin{itemize}
    \item \textbf{NichePopulation outperforms ALL baselines} in rare regimes (4/6 domains significant, $p < 0.05$)
    \item vs Homogeneous: \textbf{+21.5\%} average (identical agents lack rare-regime expertise)
    \item vs IQL: +15.6\%, vs VDN: +16.1\%, vs QMIX: +15.6\%, vs MAPPO: +16.0\%
    \item \textbf{MARL methods produce near-homogeneous populations} (SI $\approx$ 0.12--0.20) $\rightarrow$ poor rare-regime coverage
    \item NichePopulation develops rare-regime specialists in 73\% of trials
    \item Best case (Weather/Extreme): \textbf{+81.5\%} vs Homo, \textbf{+50.2\%} vs MAPPO
\end{itemize}
\end{example}
